 ...
 * sizes the sheet to whatever this scroller reports. */
const LIST_MAX_HEIGHT = 340;

/**
 * A generic settings-catalog picker: a small "{current value} ⌄" chip that
 * opens the option list in a native SwiftUI bottom sheet. The options are
 * whatever the session's harness reported (model / mode / effort catalogs) —
