...
/**
 * Desktop's scopes minus "pinned" — favouriting is desktop-only, and a tab
 * that is always empty here is worse than no tab.
 */
...
interface PagesFilterStore {
	scope: PageScope;
	/** False until AsyncStorage has answered — the saved scope isn't here yet. */
	hasHydrated: boolean;
