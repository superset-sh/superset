...
When a browser pane is focused (click inside the page):

- **⌘R** — reload that browser pane
- **⌘W** — close that browser pane

When no browser pane is focused, ⌘R reloads the app window and ⌘W does nothing.
