...
- **Mark as Unread** - Show the green dot indicator (same as when an agent completes work)
...
- File paths open in the built-in file viewer by default (configurable in Settings)
