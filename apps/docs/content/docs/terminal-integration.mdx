...
Normal multiline copying trims trailing ASCII row padding while preserving indentation, tabs, Unicode whitespace, and blank lines. Single-line and rectangular selections keep their selected text.
