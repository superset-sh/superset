...
That page needs no sign-in. It attempts the native link above, offers an
**Open Superset** button when that attempt is blocked or ignored, and points at
the download when the app isn't installed. It resolves nothing on its
