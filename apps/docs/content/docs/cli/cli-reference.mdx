...
```bash
superset agents create --workspace ws_… --agent codex --prompt "Audit the login flow"
superset agents create --workspace ws_… --agent claude --prompt "Review this diff" --attachment ./trace.log
```
</Command>
