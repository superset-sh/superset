...
<Command
	...
	output="Automation"
>
Get an automation. Use [`automations logs`](#superset-automations-logs-id)
for run history.
</Command>
...
<Command
	...
	options={[
		...
		{ flag: "--prompt <text>", description: "`-` reads from stdin." },
		{ flag: "--prompt-file <path>", description: "Read verbatim." },
	...
	output="Automation"
>
Update an automation. All flags optional. Omitting a flag preserves the
existing value — `undefined` means "no change", not "clear".
</Command>
