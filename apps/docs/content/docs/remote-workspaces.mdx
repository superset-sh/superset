...
Owners can delete a host from **Settings → Hosts**. This removes the host record itself — workspaces, files, conversations, and automations on that machine are left untouched.
