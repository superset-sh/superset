...
Host owners can rename a device from its settings page. Open **Settings → Hosts**, pick the host, then click the pencil icon next to the name. Press **Enter** to save or **Escape** to cancel. The name persists across reconnects.
