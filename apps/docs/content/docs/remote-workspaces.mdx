...
The desktop app walks you through these steps with copy-ready commands under **Settings → Hosts → Add host** (also reachable from the device picker's **Add another device**); the new host appears there live once it registers. The same steps by hand:
