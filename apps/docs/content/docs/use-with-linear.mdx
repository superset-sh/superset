...
Post that link on the issue and anyone who clicks it gets handed to their own
desktop app. The page requires no sign-in and looks nothing up — it just hands
off the workspace ID — so it also works from an email or a GitHub comment. Use
`webUrl` rather than assembling the URL yourself.
