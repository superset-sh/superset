...
Superset is a source-available AI coding platform, licensed under the Elastic License 2.0. It's available as a desktop IDE, a command-line interface, or an MCP server.
...
- macOS (Apple Silicon or Intel), or Linux x64 via the experimental AppImage. Windows is not yet available.
- Git installed
- GitHub CLI (`gh`) for the PR workflows. Optional; Superset offers to install it for you.
