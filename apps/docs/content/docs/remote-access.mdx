...
Install [Superset for iPhone](/install#iphone) and check its requirements before connecting.
...
If your computer does not appear online, see [Remote Host Won’t Connect](/troubleshooting#remote-host-wont-connect).
