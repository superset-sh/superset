...
Open **Tasks** in the dashboard sidebar to browse issues and delegate them to agents. Filters persist between visits. [Pull Requests](/pull-requests) has a separate view.
...
After creating a PR, review and merge it from [Pull Requests](/pull-requests).
