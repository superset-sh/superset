...
For agents that support it (Claude Code, Codex, Gemini CLI, Copilot, Cursor Agent, OpenCode), a model dropdown next to the agent picker lets you start the session on a specific model. Superset remembers your last choice per agent.
