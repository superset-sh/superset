...
For **PR-based workspaces**, the sidebar shows the status of CI checks on the pull request. Check statuses update automatically so you can monitor builds without leaving the app.
