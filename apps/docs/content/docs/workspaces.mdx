...
- **Pull request** - Review or continue a PR (paste a PR URL directly into the search field to jump to it)
...
Hover over a workspace in the sidebar to see its status. If the branch has a deployment preview (Vercel, Netlify, etc.), an **Open Preview** button appears alongside the "View on GitHub" link.
