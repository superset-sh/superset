...
You can paste images and screenshots directly into the prompt field — they appear as attachment pills and are sent to the agent along with your prompt.
...
Workspaces created via `superset workspaces create` automatically appear in the desktop sidebar on the same machine — no manual "Add to sidebar" step required.
