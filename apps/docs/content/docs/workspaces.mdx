...
The web app's `/workspaces` page lists all workspaces you can reach. Use the controls at the top to narrow the view:

- **Sort** — Recently created, Oldest, or Name
- **Created within** — 7, 30, or 90 days
- **Project / Host / Search** — filter by project, host, or workspace name

Each row shows a relative "created N days ago" timestamp.
