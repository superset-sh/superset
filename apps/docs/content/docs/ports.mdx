...
- **Browser actions** - Open local web servers in the in-app browser, a new in-app tab, or your default browser from the port action
...
Choose what happens when you click a port badge's open affordance in **Settings → Links → Ports**:

- **Open in in-app browser** - Current tab
- **Open in new browser tab** - New in-app tab
- **Open in default browser** - System browser (default)
