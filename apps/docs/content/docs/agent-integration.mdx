...
Superset Chat, and **Opus 5.5** for Claude Code and Superset Chat. In the Codex
workspace launcher, Sol supports reasoning effort through **Ultra**, and Luna
through **Max**. [Usage](/usage) tracks estimated token costs for these models.
