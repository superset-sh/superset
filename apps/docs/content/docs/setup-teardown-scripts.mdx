...
You can edit setup and teardown scripts directly in the app: open **Settings → Project** and use the built-in script editor. Changes save automatically on blur.
