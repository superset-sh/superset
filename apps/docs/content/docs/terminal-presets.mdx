...
- **Pin a preset** - Click the pin icon next to any preset to add it to the bar
- **Launch** - Click a pinned preset to open it in the current workspace
- **Right-click** - Context menu to open in a new tab, open in a split pane, or edit the preset
- **Reorder** - Drag pinned items to rearrange their order in the bar
- **Manage** - Click the gear icon in the preset bar to browse all presets and add quick-add templates
