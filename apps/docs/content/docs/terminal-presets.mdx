...
You can share presets through a repository file at `.superset/presets.json`.

Go to **Settings → Project → Presets** and use:
- **Export to file** to write your current presets to `.superset/presets.json`
- **Import from file** to load shared presets from `.superset/presets.json`
