...
- **gemini** - `gemini --approval-mode=auto_edit` (deprecated upstream; Google is retiring the Gemini CLI in favour of Antigravity)
- **agy** - `agy --mode accept-edits` (Google's Antigravity CLI, the Gemini CLI's replacement)
