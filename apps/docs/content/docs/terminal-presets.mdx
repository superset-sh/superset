...
The bar ships a built-in **Superset CLI** preset that opens a terminal running `superset --help`, a starting point for the [CLI](/cli/getting-started). Built-in presets can't be edited or reordered, only hidden and restored.
