...
## Binary and Video Files

Binary files show a **Binary file hidden** placeholder instead of a text diff, with an **Open file** action. Video files can be previewed directly in the file pane.
