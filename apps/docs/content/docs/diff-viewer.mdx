...
A pinned bar above the diff shows the current group (Unstaged, Staged, Committed, Against base) and file count for the topmost visible file, and updates as you scroll past each group boundary.
