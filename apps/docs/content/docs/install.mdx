...
[Download Superset for iPhone](https://apps.apple.com/app/id6788926383) to continue your agents from your phone. You need **iOS 26 or later**, **Superset Pro**, and a connected computer with **Remote Access enabled**. Sign in with the same Superset account and organization you use on desktop.
