...
import { BoardAdminPage } from "./admin/board-admin-page";
...
export const BOARD_ADMIN_PATH = "/board";
...
/** Admin 게시판 관리 */
export const createBoardAdminRoute = <T extends AnyRoute>(parentRoute: T) =>
  createRoute({
    getParentRoute: () => parentRoute,
    path: "/board",
...
/** Board의 모든 Admin Routes */
export function createBoardAdminRoutes<T extends AnyRoute>(parentRoute: T) {
  return [createBoardAdminRoute(parentRoute)];
}
