---
title: File explorer, workspace improvements, and terminal upgrades
date: 2026-02-02
...
{/* TODO: Screenshot showing file tree in action */}

## Faster Workspace Deletion <PRBadge url="https://github.com/superset-sh/superset/pull/1120" />

Workspace deletion is now significantly faster, completing in ~4-5 seconds instead of ~60 seconds. Terminal shutdowns and cleanup now run in parallel, and git worktree removal uses a non-blocking background process.
