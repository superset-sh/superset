...
|---|---|---|---|
| **Platform** | macOS, Windows, Linux | macOS | macOS; experimental Linux AppImage; Windows unavailable |
...
| **Isolation** | Git worktree per task | Git worktree per workspace | Git worktrees for local branch-based workspaces |
...
No. Conductor is a native macOS app. Orca runs on macOS, Windows, and Linux. Superset supports macOS and an experimental Linux AppImage; Windows is not available. See [Superset downloads](/download).
