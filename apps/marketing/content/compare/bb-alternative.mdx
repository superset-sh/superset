...
|---|---|---|---|
| **Superset** | A complete, supported workspace out of the box | macOS; experimental Linux AppImage; Windows unavailable | Source-available (ELv2) |
...
Yes, optionally -- a bb thread's environment can be backed by a fresh worktree. Superset creates Git worktrees for new local branch-based workspaces; Orca, Emdash, and Conductor also support worktree workflows.
