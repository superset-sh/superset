...
**Verdict:** Intent is the most complete coordinator-led orchestrator shipping today, and for well-scoped features its spec-checkpoint-verify loop is genuinely novel. Superset is the better daily driver when orchestration needs to match the full shape of real work: small fixes and big refactors, any agent, scheduled runs, and other software driving the fleet. Decide by whether you want to delegate decomposition or keep it.
