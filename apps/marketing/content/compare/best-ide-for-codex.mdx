...
|---|---|---|---|
| **Superset** | Running many local Codex tasks at once | Git worktrees for local branch-based workspaces | Not a single-file editor experience |
...
Give each Codex task its own worktree so tasks do not share a working directory. You can set this up manually, or use a workspace like Superset, which creates worktrees for new local branch-based workspaces.
