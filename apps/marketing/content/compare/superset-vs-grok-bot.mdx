...
| | **Superset** | **Grok Bot** |
|---|---|---|
| **What it does** | Runs multiple AI coding agents in parallel with Git worktree isolation, chat, review, and browser | Always-on AI teammates on a shared cloud computer that work inside tools and apps 24/7 |
...
| **Isolation** | Git worktrees for local branch-based workspaces on your own repos | Persistent cloud VM per user |
| **Clients** | macOS desktop (experimental Linux AppImage; Windows unavailable), CLI, MCP server | macOS, Windows, and Linux desktop app; iOS and Android apps |
