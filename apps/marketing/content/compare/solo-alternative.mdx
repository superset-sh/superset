...
|---|---|---|---|
| **Superset** | Parallel agents in worktrees with review and automations | macOS; experimental Linux AppImage; Windows unavailable | Source-available (ELv2) |
