...
| **Parallel agents** | Up to 8 in local worktrees | Local and cloud agents via a Kanban board | Separate local branch-based worktrees |
| **Hosts external agents** | Not advertised | Yes, via ACP (Codex, Claude, OpenCode) | Yes, any terminal agent |
| **Platform** | macOS, Windows, Linux | macOS, Windows, Linux | macOS; experimental Linux AppImage; Windows unavailable |
