...
| **Parallelism** | Core feature: multiple agents across isolated Git worktrees | One interactive session per terminal |
...
- Want to run Aider and other agents across independent tasks in parallel
- Need isolated Git worktrees so parallel work uses separate working directories
