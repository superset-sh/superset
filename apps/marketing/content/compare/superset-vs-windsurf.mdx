...
Superset runs agents locally in Git worktrees, and the full source is on GitHub under Apache 2.0. Windsurf sends code to its servers and third-party AI providers. Windsurf is closed source, so you cannot audit what data is collected or how it's processed.
...
Yes. Superset is open source under Apache 2.0. Windsurf is closed source from Codeium.
