...
| **Parallelism** | Core feature -- multiple agents across isolated worktrees | Manages local and cloud agents from a Kanban command center |
| **Isolation** | Git worktrees for local branch-based workspaces | Cloud isolated; local mechanism not clearly documented |
