...
keywords:
  ...
  - openai coding agent
faq:
  - question: "Is Superset a Codex replacement?"
    answer: "No. Superset does not talk to AI models or write code. It orchestrates agents like Codex in parallel, each in its own Git worktree. Think of Superset as a multiplier for Codex, not a substitute."
  - question: "Can I run Codex in Full Auto mode inside Superset?"
    answer: "Yes. Each Superset task runs Codex in its own isolated worktree. You can use any Codex mode — Suggest, Auto Edit, or Full Auto — safely, because worktree isolation means an autonomous agent can't affect your main working directory."
  ...
  - question: "Are both tools open source?"
    answer: "Yes. Both Superset and Codex CLI are open source under Apache 2.0. You can inspect, modify, and self-host either."
---
...
- [Superset vs Claude Code](/compare/superset-vs-claude-code) — How Superset orchestrates Anthropic's coding agent
