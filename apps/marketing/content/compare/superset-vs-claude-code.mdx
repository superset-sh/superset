...
No. Superset is source-available on GitHub under Elastic License 2.0 (ELv2) with zero telemetry. Claude Code is also source-available rather than open source.
