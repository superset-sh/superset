...
|---|---|---|---|
| **Superset** | Fleet-scale parallel agents with visibility, review, and automations | macOS; experimental Linux AppImage; Windows unavailable | Source-available (ELv2) |
