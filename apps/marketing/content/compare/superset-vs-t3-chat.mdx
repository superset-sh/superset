...
| **What it does** | Runs multiple coding agents in parallel with Git worktrees, built-in chat, diff/file review, and browser preview | Lets you chat with multiple frontier models from one hosted interface |
...
| **Isolation** | Git worktrees for local branch-based workspaces | No Git worktree or branch isolation |
