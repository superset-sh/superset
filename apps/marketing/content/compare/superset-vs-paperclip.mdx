...
| | **Superset** | **Paperclip** |
|---|---|---|
| **What it does** | Runs multiple AI agents in parallel with Git worktree isolation, chat, review, and browser | Orchestrates a team of agents against goals with tickets, org charts, budgets, and governance |
...
| **Isolation** | Git worktrees for local branch-based workspaces on your machines | Server-side worktrees/branches; cloud sandboxes (e2b, Modal, Daytona, Kubernetes) |
