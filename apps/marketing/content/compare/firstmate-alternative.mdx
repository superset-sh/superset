...
|---|---|---|---|
| **Superset** | The same delegation pattern with a real workspace around it | macOS; experimental Linux AppImage; Windows unavailable | Source-available (ELv2) |
...
Superset creates worktrees for new local branch-based workspaces; Orca also supports worktree workflows; Claude Squad and Herdr manage worktrees for their sessions; Gas Town's "hooks" are git worktree-backed persistent work state.
