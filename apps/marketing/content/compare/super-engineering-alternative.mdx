...
|---|---|---|---|
| **Superset** | A shipping product with automations, CLI/SDK/MCP, and teams | macOS; experimental Linux AppImage; Windows unavailable | Source-available (ELv2) |
...
super.engineering requires macOS 14 or newer on a Metal-capable Mac and serves an Apple Silicon build. Orca, Paseo, and Emdash run on macOS, Windows, and Linux today; Superset supports macOS on Apple Silicon and Intel, ships an experimental Linux build, and does not yet support Windows.
