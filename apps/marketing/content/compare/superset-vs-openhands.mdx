...
| **Parallelism** | Core feature: multiple agents across isolated worktrees | Multiple sessions, typically one sandbox per task |
...
- Want local branch-based task workspaces without requiring a container runtime
