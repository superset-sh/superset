			...
			<div className="max-w-3xl mx-auto px-6 py-12">
				...
				>
					...
					<section className="mb-12">
						...
						<p className="text-zinc-300 mb-4">
							Create a <code className="text-amber-400">config.json</code> file
							in your project&apos;s{" "}
					...
					<section className="mb-12">
						...
						<ol className="list-decimal list-inside text-zinc-300 space-y-3 ml-4">
							...
							<li>
								...
								with setup commands, they run automatically in the new worktree
							</li>
					...
					<section className="mb-12">
						...
						<ul className="list-disc list-inside text-zinc-300 space-y-2 ml-4">
							...
							<li>
								Use <code className="text-amber-400">&&</code> to chain commands
