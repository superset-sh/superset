  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <p className="text-sm text-muted-foreground" data-testid="accounts-count">
          {accountList.length}개 계정 연결됨
        </p>
      </CardHeader>
      <CardContent>
        {accountList.length === 0 ? (
          <div className="text-center py-8 text-muted-foreground" data-testid="accounts-empty-state">
            연결된 SNS 계정이 없습니다.
          </div>
        ) : (
          <Table>
