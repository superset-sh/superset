  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="flex items-center gap-2" data-testid="calendar-month-display">
          <Calendar className="h-5 w-5" />
          {year}년 {month + 1}월
        </CardTitle>
        <div className="flex items-center gap-1">
          <Button variant="ghost" size="sm" onClick={prevMonth} data-testid="calendar-prev-btn">
            <ChevronLeft className="h-4 w-4" />
          </Button>
          <Button variant="ghost" size="sm" onClick={nextMonth} data-testid="calendar-next-btn">
