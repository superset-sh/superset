				...
				{preset ? (
					<>
						<DialogHeader>
							...
							<DialogDescription>
								Configure commands, targeting and launch behavior.
							</DialogDescription>
						</DialogHeader>
						...
						<div className="grid gap-5 sm:grid-cols-2">
							<Field
								label="Name"
								htmlFor="preset-name"
								hint="Shown in your presets list and launch surfaces."
							>
								<Input
									id="preset-name"
									value={preset.name}
							...
							<Field
								...
								hint="Optional. A short reminder of what this does."
							>
								<Input
									...
									placeholder="e.g. Starts the dev server"
								/>
							</Field>
							...
							<div className="sm:col-span-2">
								<Field
									label="Applies to"
									hint="Limit to specific projects or make it available everywhere."
								>
							...
							<div className="sm:col-span-2 space-y-1.5">
								...
								<div className="flex items-center gap-2">
									<Input
										...
										placeholder="e.g. ./apps/web or /full/path"
									/>
									<Button
										type="button"
										variant="outline"
								...
								<p className="text-xs text-muted-foreground">
									Working directory. Use <code>./apps/web</code> for a
									workspace-relative path or pick an absolute folder.
								</p>
								{trimmedCwd &&
								isAbsolutePath &&
							...
							<div className="sm:col-span-2">
								<Field
									label="Launch mode"
									hint="Whether commands open in the current tab, in panes, or in their own tabs."
								>
									{hasMultipleCommands ? (
										<RadioGroup
											value={modeValue}
							...
							<div className="sm:col-span-2 space-y-3 rounded-md border border-border p-3">
								<div className="space-y-0.5">
									...
									<p className="text-xs text-muted-foreground">
										When this preset should launch automatically.
									</p>
								</div>
