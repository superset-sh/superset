...
import type { WorkspacePrSummary } from "renderer/routes/_authenticated/_dashboard/workspaces/hooks/useAccessibleWorkspaces";

interface WorkspaceChecksDotProps {
	status: WorkspacePrSummary["checksStatus"];
	checks: CheckItem[];
}
