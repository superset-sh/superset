...
interface WorkspaceContextMenuProps {
	...
	children: (actions: WorkspaceActions) => ReactNode;
}
...
export function WorkspaceContextMenu({
	...
	const open = useCallback(() => {
		const go = () => navigateToWorkspace(workspace.id, navigate);
	...
	const removeFromSidebar = useCallback(() => {
		...
		// auto-add-local-workspaces hook treats a missing workspaceLocalState
