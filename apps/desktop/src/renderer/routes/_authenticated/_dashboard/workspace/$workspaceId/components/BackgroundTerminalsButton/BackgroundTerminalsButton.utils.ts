...
const BACKGROUND_TERMINAL_CLOSED_REFETCH_INTERVAL_MS = 10_000;
const BACKGROUND_TERMINAL_OPEN_REFETCH_INTERVAL_MS = 2_000;
...
interface BackgroundTerminalSessionLike {
	terminalId: string;
	createdAt?: number;
}
