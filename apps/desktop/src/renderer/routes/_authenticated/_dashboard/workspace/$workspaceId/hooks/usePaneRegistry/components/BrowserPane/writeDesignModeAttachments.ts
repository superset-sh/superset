...
type WorkspaceTrpcClient = ReturnType<typeof workspaceTrpc.useUtils>["client"];
...
interface DesignModeAttachmentPaths {
 ...
 *
 * Goes through the host-service filesystem router, which owns the workspace
 * records in host.db.
 */
