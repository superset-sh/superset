...
export function AgentPlacementToggle({
	...
	return (
		<ToggleGroup
			...
			className="ml-1 h-[var(--btn-h-default)] gap-0 rounded bg-grayAlpha-100 p-0.5"
		>
			<ToggleGroupItem
				value="split-pane"
				aria-label={t({
				...
				className="h-[var(--btn-h-sm)] gap-1 rounded px-1.5 text-xs text-muted-foreground data-[state=on]:bg-accent data-[state=on]:text-foreground"
			>
