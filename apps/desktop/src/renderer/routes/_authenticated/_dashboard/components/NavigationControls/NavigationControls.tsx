			...
			<Tooltip delayDuration={1000}>
				<TooltipTrigger asChild>
					<button
						...
						disabled={!canGoBack}
						className="no-drag flex items-center justify-center size-7 rounded text-muted-foreground hover:bg-fill-hover transition-colors disabled:opacity-30 disabled:pointer-events-none"
					>
