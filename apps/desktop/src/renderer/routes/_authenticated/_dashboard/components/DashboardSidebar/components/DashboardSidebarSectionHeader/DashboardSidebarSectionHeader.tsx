...
export function DashboardSidebarSectionHeader({
	...
	return (
		...
		<div
			...
			className="group flex h-[var(--btn-h-default)] w-full shrink-0 items-center gap-1.5 pl-2 pr-2 text-[10px] font-semibold uppercase tracking-[0.075em] text-muted-foreground transition-colors"
		>
