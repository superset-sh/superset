...
export function DashboardSidebarWorkspaceDiffStats({
	...
	return (
		<div className="flex h-5 w-fit shrink-0 items-center justify-self-end text-micro font-mono tabular-nums transition-[opacity,visibility] group-hover:opacity-0 group-hover:invisible">
