		...
		<div className="flex h-full w-full items-center justify-center p-6">
			<div className="flex w-full max-w-sm flex-col items-start gap-5">
				...
				<div className="flex flex-col gap-1.5">
					<h1 className="text-md font-medium tracking-tight text-foreground select-text cursor-text">
						<Trans id="dashboard.crossVersionMismatchState.title">
							Pick a workspace
						</Trans>
					</h1>
					<p className="text-sm leading-relaxed text-muted-foreground select-text cursor-text">
