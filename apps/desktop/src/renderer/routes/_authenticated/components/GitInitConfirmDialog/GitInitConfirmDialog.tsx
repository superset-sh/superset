 ...
 * the folder-first import flow; mounted once in the _authenticated layout so
 * every caller (onboarding, File menu, command palette, dashboard) can resolve
 * the request — an unmounted dialog would leave request() pending forever.
 */
