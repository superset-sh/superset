...
export function markWorkspaceRunLaunchPending(paneId: string): void {
	pendingWorkspaceRunLaunches.add(paneId);
}

export function clearWorkspaceRunLaunchPending(paneId: string): void {
	pendingWorkspaceRunLaunches.delete(paneId);
}

export function isWorkspaceRunLaunchPending(paneId: string): boolean {
