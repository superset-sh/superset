 ...
 */
export function rememberPaneSelection<TData>(
	workspaceId: string,
...
export function applyRememberedPaneSelection<TData>(
	workspaceId: string,
	state: WorkspaceState<TData>,
...
export function clearRememberedPaneSelectionsForTest(): void {
	selections.clear();
}
