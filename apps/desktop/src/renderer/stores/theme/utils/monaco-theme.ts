...
function createEditorColors(theme: Theme): editor.IColors {
	...
	return {
		...
		"diffEditor.insertedTextBackground": alpha(terminal.green, 0.22),
		"diffEditor.removedTextBackground": alpha(terminal.red, 0.22),
		"diffEditor.insertedLineBackground": alpha(terminal.green, 0.15),
		"diffEditor.removedLineBackground": alpha(terminal.red, 0.15),
		"diffEditorGutter.insertedLineBackground": alpha(terminal.green, 0.25),
		"diffEditorGutter.removedLineBackground": alpha(terminal.red, 0.25),
