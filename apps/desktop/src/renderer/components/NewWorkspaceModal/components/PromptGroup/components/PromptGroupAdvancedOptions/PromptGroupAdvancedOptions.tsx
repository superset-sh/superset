		...
		<Collapsible open={showAdvanced} onOpenChange={onShowAdvancedChange}>
			...
			<CollapsibleContent className="pt-3 space-y-3">
				<div className="space-y-1.5">
					...
					<Input
						id="branch"
						className="h-[var(--input-h)] text-sm font-mono"
						placeholder={t({
				...
				{showCompareBaseBranch && (
					<div className="space-y-1.5">
						...
						{isBranchesError ? (
							<div className="flex items-center gap-2 h-[var(--input-h)] px-3 rounded border border-destructive/50 bg-destructive/10 text-destructive text-xs">
