			...
			<div className="w-[300px] bg-[#1a1a1a]/90 backdrop-blur-sm rounded-lg border border-white/10 shadow-2xl overflow-hidden">
				...
				<div className="flex items-center justify-between px-4 py-3 bg-[#2a2a2a]/80 border-b border-white/5">
					<div className="flex items-center gap-2">
						...
						<span className="text-xs text-white/60 ml-1">Integrations</span>
					</div>
				</div>
				...
				<div className="p-4">
					<div className="flex items-center justify-center gap-6 mb-4 py-2">
						<div className="flex flex-col items-center gap-1.5">
							...
							<span className="text-[10px] text-white/60">Linear</span>
						</div>
						...
						<div className="flex flex-col items-center gap-1.5">
							...
							<span className="text-[10px] text-white/60">GitHub</span>
						</div>
					</div>
