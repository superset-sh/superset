...
export const BATCH_GITHUB_STATUS_REFETCH_INTERVAL_MS = 15_000;
const WORKSPACE_LIST_ITEM_GITHUB_STATUS_STALE_TIME_MS =
	BATCH_GITHUB_STATUS_REFETCH_INTERVAL_MS;
