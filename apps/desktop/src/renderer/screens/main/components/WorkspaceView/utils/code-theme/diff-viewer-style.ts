...
export function getDiffViewerStyle(
	...
	return {
		...
		"--diffs-light": editorTheme.colors.foreground,
		"--diffs-dark": editorTheme.colors.foreground,
		"--diffs-light-bg": editorTheme.colors.background,
		"--diffs-dark-bg": editorTheme.colors.background,
