			...
			<DialogContent className="max-w-[calc(100vw-2rem)] overflow-hidden sm:max-w-lg">
				<DialogHeader>
					...
					<DialogDescription>
						...
						paste the redirected localhost URL below.
					</DialogDescription>
				</DialogHeader>
				...
				<div className="min-w-0 space-y-4">
					<div className="rounded-lg border border-border/70 bg-muted/15 px-4 py-3 text-sm text-muted-foreground">
						...
						land on `http://localhost:1455/auth/callback?...`, copy that full
					...
					<div className="min-w-0 space-y-2">
						...
						<InputGroup className="border-border/70 bg-muted/10">
							<InputGroupInput
								...
								placeholder="Paste full http://localhost:1455/auth/callback?... URL"
								value={code}
