...
export function EmptyTabActionButton({
	...
	return (
		<Button
			type="button"
			variant="ghost"
			className="group h-[var(--btn-h-xl)] w-full justify-between rounded px-3 text-sm text-muted-foreground/80 transition-colors hover:bg-tertiary/60 hover:text-foreground"
			onClick={onClick}
		>
