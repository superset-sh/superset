...
const SIDEBAR_HEADER_TAB_ACTIVE_CLASS_NAME = "text-foreground bg-fill-selected";
const SIDEBAR_HEADER_TAB_INACTIVE_CLASS_NAME =
	"text-muted-foreground/70 hover:text-muted-foreground hover:bg-fill-hover";
...
const SIDEBAR_HEADER_TAB_INACTIVE_INVERTED_CLASS_NAME =
	"bg-fill-hover text-muted-foreground/70 hover:text-muted-foreground hover:bg-fill-selected border border-transparent border-b-border";
...
export const sidebarHeaderTabTriggerClassName = cn(
	...
	"data-[state=active]:bg-fill-selected data-[state=active]:text-foreground data-[state=active]:shadow-none",
	"data-[state=inactive]:text-muted-foreground/70 data-[state=inactive]:hover:bg-fill-hover data-[state=inactive]:hover:text-muted-foreground",
);
