...
mock.module("@ai-sdk/anthropic", () => ({
	createAnthropic: mock(() => mock(() => "anthropic-default-model")),
}));

mock.module("@ai-sdk/openai", () => ({
	createOpenAI: mock(() => mock(() => "openai-default-model")),
}));

mock.module("@superset/chat/host", () => ({
	getCredentialsFromAnySource: mock(() => null),
	getAnthropicProviderOptions: mock(() => ({ apiKey: "unused" })),
	getOpenAICredentialsFromAnySource: mock(() => null),
