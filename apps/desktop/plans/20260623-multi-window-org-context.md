...
- [ ] Milestone 2 manual verification (user, running dev): two windows on two orgs, independent; `x-superset-organization-id` sent per window; session not mutated by switching.
