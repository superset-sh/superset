...
export const checkout = protectedProcedure
	...
	.mutation(async ({ ctx, input }) => {
		// Single seam for clearing progress on every throw path. Mirrors
		// `workspaceCreation.create`. The scattered clearProgress calls
		// inside are now redundant but harmless (idempotent).
		try {
