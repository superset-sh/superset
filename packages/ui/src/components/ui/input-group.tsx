...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		...
		<div
			...
			role="group"
			className={cn(
				"group/input-group border-input dark:bg-input/30 relative flex w-full items-center rounded-xl border-[0.5px] shadow-none transition-[color,box-shadow] outline-none",
