...
export const AGENT_PRESET_COMMANDS: Record<AgentType, string[]> = {
	...
	codex: [
		'codex -c model_reasoning_effort="high" --dangerously-bypass-approvals-and-sandbox -c model_reasoning_summary="detailed" -c model_supports_reasoning_summaries=true --enable codex_hooks',
	],
	gemini: ["gemini --yolo"],
	mastracode: ["mastracode"],
	opencode: ["opencode"],
