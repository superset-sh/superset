...
// User settings (synced across devices for a user)
...
// Organization settings (shared across org members)
export const orgSettings = pgTable(
	...
	(table) => [
		unique("org_settings_unique").on(table.organizationId, table.key),
		index("org_settings_organization_id_idx").on(table.organizationId),
	],
);

export type InsertOrgSetting = typeof orgSettings.$inferInsert;
export type SelectOrgSetting = typeof orgSettings.$inferSelect;
