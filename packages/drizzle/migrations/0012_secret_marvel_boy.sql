...
ALTER TABLE "story_studio_projects" ADD CONSTRAINT "story_studio_projects_author_id_profiles_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."profiles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
