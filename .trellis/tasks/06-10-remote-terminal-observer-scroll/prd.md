...
- Passed: `bun test packages/host-service/src/terminal/terminal-replay-snapshot.test.ts packages/host-service/src/terminal/terminal-mode-tracker.test.ts packages/host-service/src/terminal/env.test.ts apps/desktop/src/renderer/lib/terminal/terminal-ws-transport.test.ts`.
- Passed: `bun --cwd apps/desktop typecheck`.
- Passed: `bun run lint`.
