...
|---------|------|---------|---------|
| 1.3.1 | 2026-05-21 | Strip references to the unmerged desktop chat-v2 PRD from `01-scope.md` rationale lines and from the README naming note — that PRD is a local draft not visible to reviewers, so it can't function as evidence. Rewrote affected Why sections to stand on the existing repo-state findings alone. |  Reviewer-visibility cleanup |
